          ...
          {modalTab === 'general' ? (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-3 pb-4">
                ...
                <input type="file" id="dish-img-up-stepper" className="hidden" onChange={handleImage} />
                <button onClick={() => document.getElementById('dish-img-up-stepper')?.click()} className="w-full aspect-video bg-white border border-slate-200 rounded-[2rem] overflow-hidden flex flex-col items-center justify-center gap-3 transition-all hover:border-[#007AFF]/30 group relative shadow-inner">
                  {formData.image ? (
                    <>
