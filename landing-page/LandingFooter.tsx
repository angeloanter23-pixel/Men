    ...
    <div className="max-w-[1100px] mx-auto">
       <div className="grid grid-cols-2 md:grid-cols-4 gap-12 pb-20 border-b border-slate-200">
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3.5 text-[14px] font-semibold text-slate-400">
              <li><button className="hover:text-orange-500 transition-colors">Guides</button></li>
              <li><button className="hover:text-orange-500 transition-colors">API Docs</button></li>
              <li><button className="hover:text-orange-500 transition-colors">Case Studies</button></li>
              <li><button className="hover:text-orange-500 transition-colors">Help Center</button></li>
            </ul>
          </div>

          {/* Legal Links */}
          <div className="space-y-5">
            <h4 className="text-[10px] font-black text-slate-900 uppercase tracking-[0.3em]">Corporate</h4>
            <ul className="space-y-3.5 text-[14px] font-semibold text-slate-400">
              ...
              <li><button className="hover:text-orange-500 transition-colors">Node Registry</button></li>
              <li><button className="hover:text-orange-500 transition-colors">Compliance</button></li>
            </ul>
          </div>
       ...
       <div className="pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-slate-100 shadow-sm">
            ...
            <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-none">Global Status: Operational</span>
          </div>
       </div>
    </div>
  </footer>
