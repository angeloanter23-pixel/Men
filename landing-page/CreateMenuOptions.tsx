        ...
        <div className="space-y-8 animate-slide-up">
          <header className="text-center space-y-3">
            <h2 className="text-3xl font-black text-slate-900 tracking-tight uppercase">
              Get Started <span className="text-xs font-mono text-slate-400 align-top ml-1">v2.0</span>
            </h2>
          ...
          <button 
            ...
            disabled={loading}
            className="w-full py-5 bg-white border border-slate-200 hover:border-slate-900 text-slate-900 rounded-2xl font-bold text-sm transition-all flex items-center justify-center gap-4 uppercase tracking-widest"
          >
            {loading ? (
